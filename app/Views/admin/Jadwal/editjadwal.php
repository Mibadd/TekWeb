    ...
    <?php if (!empty($sukuCadang)): ?>
        <?php foreach ($sukuCadang as $suku): ?>
            <div class="form-check">
                <input type="checkbox" name="sukucadang[]" value="<?= $suku['id'] ?>"
                    id="suku<?= $suku['id'] ?>" class="form-check-input"
                    <?= in_array($suku['id'], $sukuCadangTerpakai) ? 'checked' : '' ?>>
                <label for="suku<?= $suku['id'] ?>" class="form-check-label">
                    <?= $suku['nama'] ?> (Stok: <?= $suku['stok'] ?>)
                </label>
            </div>
        <?php endforeach; ?>
    <?php else: ?>
